...
use yantra::udev::{UdevEvent, classify_device, device_info_from_udev, extract_capabilities};
...
fn make_toc() -> DiscToc {
    DiscToc {
        ...
        tracks: vec![
            TocEntry { number: 1, track_type: TrackType::Audio, start_lba: 0, length_sectors: 22050, duration_secs: Some(180.5) },
            TocEntry { number: 2, track_type: TrackType::Audio, start_lba: 22050, length_sectors: 18000, duration_secs: Some(240.0) },
            TocEntry { number: 3, track_type: TrackType::Data, start_lba: 40050, length_sectors: 100000, duration_secs: None },
        ],
...
fn bench_device_info(c: &mut Criterion) {
    ...
    group.bench_function("size_display", |b| {
        let info = make_device_info();
...
fn bench_optical(c: &mut Criterion) {
    ...
    group.bench_function("detect_disc_type", |b| {
